    ...
    <div class="main-body">
        ...
        <div class="center-body">
            <div class="left-center">
                <div class="sideMenu">
                    ...
                    <div class="leftSideMenu">
                        <ul>
                            <li><a href="?p=1">Balance Details Report</a></li>
                            <li><a href="?p=2">Date Wise Balance Report</a></li>
                            <li><a href="?p=3">Name Wise Report</a></li>
                            <li><a href="?p=4">Date and Name wise Report</a></li>
                        </ul>
                    </div>
            ...
            <div class="mid-center">
                ...
                {
                    if ($pageName == 1) {
                        include_once 'balance-report.php';
                    } else if ($pageName == 2) {
                        include_once 'datewise-report.php';
                    } else if ($pageName == 3) {
